...
There are currently 415 different analyzers that check the PHP code to report code smells. Analyzers are inspired by PHP manual, migration documents, community good practices, computer science or simple logic. 
...
.. image:: images/dashboard.748.png
    :alt: 415 analysis with faceted search
