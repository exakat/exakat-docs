...
When using a type for a method, it is compulsory to use a at least one return in the method's body. This is `true <https://www.php.net/true>`_ for nullable type too : ``return`` alone won't be sufficient.
